...
The revised architecture will separate responsibilities:

- Frontend stores and sends chat history plus structured conversation state.
- Lambda decides route, topic, memory progression, and next options.
...
The new response contract will support:
...
Important revised rule:

- `answer` contains only the answer bullets.
...
- Write the grounded 3-bullet answer body only.
- Stay within the provided route, topic, and context.
